...
function CartOverview() {
  ...
  return state.length ? (
    <>
      <div
        id="cart"
        className=" relative container mx-auto mt-4  text-[#1b1b1b]"
      >
        <h1 className="capitalize xs:text-[1rem] mx-1 text-[2rem] font-semibold">
          shopping bag
        </h1>
        <h2 className=" mx-8">
      ...
      <div className="container mx-auto mb-8 xs:p-2 ">
        <div className=" gap-4 grid xl:grid-cols-[1fr_auto]">
          <div className=" relative border border-stone-400 rounded-lg mt-[2rem]">
            ...
            <ul className=" flex text-[#1b1b1b] xl:text-[1rem] md:text-[1rem] xs:text-[.6rem] justify-between p-4 border-b border-stone-400 font-semibold">
              <li>Prodcut Image</li>
              <li>Prodcut Name</li>
              <li>Quantity</li>
              <li>Price</li>
          ...
          <div className="  top-[8rem]  rounded-lg mt-[2rem] text-[#1b1b1b] ">
            <div className="border p-6 border-stone-600  xL:w-[20rem] mb-[1rem] rounded-xl">
