...
function EmptyCart() {
  ...
  return (
    <div className=" xl:w-full h-[80vh] flex justify-center items-center ">
      <div
        id="empty"
        className="bg-white xl:w-[50rem] sx:w-[20rem] sx:h-[10rem] xl:h-[15rem] flex justify-center border border-[#dc2626] items-center rounded-2xl  p-4"
      >
        <div className=" ">
          <p className="xl:text-[1.8rem] xs:text-[1rem] italic font-serif text-[#1b1b1b]">
            Your cart is empty 😊
          </p>
          <div className="flex justify-center">
            ...
            >
              <h1>Go fill it </h1>
              <FaTruckArrowRight id="car" className=" text-[#dc2626]" />
            </Link>
          </div>
        </div>
      </div>
