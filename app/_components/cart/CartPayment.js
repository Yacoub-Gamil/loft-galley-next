...
function CartPayment({ totalPrice, setShowModal }) {
  return (
    <div className=" relative">
      <div className=" sticky top-[8rem]">
        <div className="border p-6 xL:w-[20rem] mb-[1rem] bg-white ">
        ...
        <div className=" flex flex-col gap-2 justify-center font-semibold items-center">
          <button
            ...
            className="w-full bg-[#dc2626] duration-300 hover:scale-x-105 text-white bg-opacity-90 capitalize  p-2"
          >
            proceed to secure checkout
          </button>
          <Link
            href="/collection"
            className=" border-[.1px] border-orange-600 duration-300 hover:scale-105 text-[#dc2626] capitalize  p-2 w-full text-center"
          >
            continue shopping
          </Link>
        </div>
