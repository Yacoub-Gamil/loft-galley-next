    ...
    <main className="">
      <div className=" relative  h-[90vh] bg-[#1b1b1b]">
        ...
        <div className="w-full h-full absolute flex justify-center items-center z-30">
          <div className="flex flex-col items-center gap-4 bg-white bg-opacity-90 shadow-[0px_0px_5px_5px_#e2e8f0] p-4 w-[50rem]">
            ...
            <Link
              href="/collection"
              className="flex items-center gap-2 group tracking-widest font-serif text-[1.6rem] border-b border-[#dc2626] text-black px-7 py-2"
            >
